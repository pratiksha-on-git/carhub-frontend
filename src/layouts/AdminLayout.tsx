import { LayoutDashboard, Users, CarFront, Inbox, CreditCard, Megaphone, FileBarChart } from "lucide-react";
import DashboardLayout from "./DashboardLayout";

const nav = [
  { to: "/admin/dashboard", label: "Dashboard", icon: <LayoutDashboard className="h-4 w-4" /> },
  { to: "/admin/dealers", label: "Dealers", icon: <Users className="h-4 w-4" /> },
