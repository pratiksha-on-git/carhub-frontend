...
export default function DealerDashboard() {
  ...
  const {
    ...
    isRefetching: viewsRefetching,
  } = useVehicleViews(dealerId);
  const {
    data: leadsData = [],
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button
                ...
                disabled={viewsRefetching}
              >
                <RefreshCw
                  className={`h-3.5 w-3.5 ${viewsRefetching ? "animate-spin" : ""}`}
                />
              </Button>
            </div>
            {viewsLoading ? (
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              >
                <RefreshCw
                  className={`h-3.5 w-3.5 ${leadsRefetching ? "animate-spin" : ""}`}
                />
              </Button>
            </div>
            {leadsLoading ? (
